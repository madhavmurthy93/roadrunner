...
/** @file EpipExecutableModel.h
  * @author MM
  * @date 01/12/2015
  * @copyright Apache License, Version 2.0
  * @brief A model which is compiled for the Epiphany chip
  **/

/*
 * EpipExecutableModel.h
 *
...
#ifndef rrEpipExecutableModelH
#define rrEpipExecutableModelH
...
/*
#define RR_Epip_USE_LLVM_MODEL 0
# if RR_Epip_USE_LLVM_MODEL
# if !defined(BUILD_LLVM)
#     error "Must be building LLVM to specify RR_Epip_USE_LLVM_MODEL"
# endif
# endif
 ...
 */
class RR_DECLSPEC EpipExecutableModel: public ExecutableModel
{
public:
     ...
     */
    EpipExecutableModel(std::string const &sbml, unsigned loadSBMLOptions);


    virtual ~EpipExecutableModel();
    ...
    Hashval getSBMLHash() const {
        if(!sbmlhash_)
           throw_Epip_exception("No stored hash");
        return *sbmlhash_;
    }
...
/*
    ...
    void checkLLVMModel() const { if (!llvmmodel_) throw_Epip_exception("No LLVM Model"); }
